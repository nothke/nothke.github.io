...
var TimeThread = /** @class */ (function () {
    ...
    TimeThread.prototype.add = function (color, segs, titleText, textLevel) {
        ...
        if (titleText !== "") {
            ...
            */
            ...
            titleTextBlock = new TextBlock(titleText, segs[0].date, segs[segs.length - 1].date, this.yBase + yText + textOffset, svg);
            //titleTextBlock.setY(this.yBase + yText + textOffset);
            //svg.appendChild(titleTextBlock.element);
        }
        this.threads.push(new Thread(color, segs, path, titleTextBlock));
    };
    /*
    init() {
